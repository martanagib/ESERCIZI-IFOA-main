...
for (let i = 0; i < femaleCharacters.length; i++) {
  for (let a = 0; a < characters.length; a++) {
    if (femaleCharacters[i].name === characters[a]){
    characters.splice(a,1); //l'istruzione splice rimuove uno o più elementi ed eventualmente li sostitusce con qualcos altro
    }
}
}
console.log(characters.length);
